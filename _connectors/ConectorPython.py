...
class ConectorV3:
    ...
    def DefinirCaracterPersonalizado(
        self, caracterRemplazoComoCadena: str, matrizComoCadena: str
    ):
        return self.agregar_operacion(
            "DefinirCaracterPersonalizado",
            [caracterRemplazoComoCadena, matrizComoCadena],
        )

    def DescargarImagenDeInternetEImprimir(
        self, urlImagen: str, tamaño: float, maximoAncho: float
    ):
        return self.agregar_operacion(
            "DescargarImagenDeInternetEImprimir", [urlImagen, tamaño, maximoAncho]
        )

    def DeshabilitarCaracteresPersonalizados(
        self,
    ):
        return self.agregar_operacion("DeshabilitarCaracteresPersonalizados", [])

    def DeshabilitarElModoDeCaracteresChinos(
        self,
    ):
    ...
    def EstablecerTamañoFuente(
        self, multiplicadorAncho: float, multiplicadorAlto: float
    ):
        return self.agregar_operacion(
    ...
    def ImprimirCodigoDeBarrasCodabar(
        self, contenido: str, alto: float, ancho: float, tamañoImagen: float
    ):
        return self.agregar_operacion(
            "ImprimirCodigoDeBarrasCodabar", [contenido, alto, ancho, tamañoImagen]
        )

    def ImprimirCodigoDeBarrasCode128(
        self, contenido: str, alto: float, ancho: float, tamañoImagen: float
    ):
        return self.agregar_operacion(
    ...
    def ImprimirCodigoDeBarrasCode39(
        self,
        contenido: str,
        incluirSumaDeVerificacion: bool,
        modoAsciiCompleto: bool,
        alto: float,
        ancho: float,
        tamañoImagen: float,
    ):
    ...
    def ImprimirCodigoDeBarrasCode93(
        self, contenido: str, alto: float, ancho: float, tamañoImagen: float
    ):
        return self.agregar_operacion(
    ...
    def ImprimirCodigoDeBarrasEan8(
        self, contenido: str, alto: float, ancho: float, tamañoImagen: float
    ):
        return self.agregar_operacion(
    ...
    def ImprimirCodigoDeBarrasPdf417(
        self,
        contenido: str,
        nivelSeguridad: float,
        alto: float,
        ancho: float,
        tamañoImagen: float,
    ):
        return self.agregar_operacion(
            ...
            [contenido, nivelSeguridad, alto, ancho, tamañoImagen],
        )

    def ImprimirCodigoDeBarrasTwoOfFiveITF(
        self,
        contenido: str,
        intercalado: bool,
        alto: float,
        ...
        return self.agregar_operacion(
            ...
            [contenido, intercalado, alto, ancho, tamañoImagen],
        )

    def ImprimirCodigoDeBarrasUpcA(
        self, contenido: str, alto: float, ancho: float, tamañoImagen: float
    ):
        return self.agregar_operacion(
    ...
    def ImprimirCodigoDeBarrasUpcE(
        self, contenido: str, alto: float, ancho: float, tamañoImagen: float
    ):
        return self.agregar_operacion(
    ...
    def ImprimirCodigoQr(
        self,
        contenido: str,
        anchoMaximo: float,
        nivelRecuperacion: float,
        tamañoImagen: float,
    ):
        return self.agregar_operacion(
            "ImprimirCodigoQr",
            [contenido, anchoMaximo, nivelRecuperacion, tamañoImagen],
        )

    def ImprimirImagenEnBase64(
        self, imagenCodificadaEnBase64: str, tamaño: float, maximoAncho: float
    ):
        return self.agregar_operacion(
